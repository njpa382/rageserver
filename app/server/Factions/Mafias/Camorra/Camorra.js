...
class Camorra extends Mafia {
    constructor() {
        ...
        jobParamenters.basicInformation = {
            name: "Mafia_Camorra", x: 441.211, y: -976.772, z: 30.69, rot: 0,
            dim: 0, faction_id: faction_id_const, className: "Camorra", blipInfo: { id: 526, color: 3 }
        };
        ...
        jobParamenters.factionVehiclesList = [
            { model: "tulip", minimunRank: 1, title: "Camorra 1 ", fuel: 40, id: 0, numberPlate: "Camorra000" },
        ];
